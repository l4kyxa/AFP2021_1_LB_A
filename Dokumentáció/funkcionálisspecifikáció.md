...
A képernyőterv túlszárnyalta a jelenleg rendelkezésre álló időt, energiát, munkát. Akármennyire igyekeztünk, meg kellett elégednünk azzal, hogy a weboldal egyelőre az alapvető funkciókat tartalmazza. A projekt kezdetekor elkészített képernyőtervet szeretnénk felhasználni a tantárgy 2. kurzusa során.  
A tervet Axure szoftverrel készítettem el, és bár a szoftver használata nem volt túlságosan nehéz, ennek ellenére a kezelésének tanulási folyamata sok időt vett igénybe, ezért a képernyőterv egy részét tudtam csak kivitelezni. El kellett kezdenem a tényleges munkát, hogy a rendelkezésre álló időben a végére tudjak érni a kitűzött céloknak.
A terv eredménye a https://zxb0g0.axshare.com/#id=v3dnyn&p=f_oldal linken található, a hozzáférési jelszó: wireframe. A főoldalon jelennek meg a weboldal legfontosabb információi, melynek legfontosabb része az oldal tetején található horizontális menü. A menü tartalmazza a termékeket kategorizálva  (2. kurzus célkitűzése). Mellette egy kreatív hobbi fül van (szintén a 2. kurzus célkitűzése), amelyen ötleteiket oszthatják meg a felhasználók, legyen szó varrásról, vagy bármilyen más kreatív illetve költséghatékony megoldásról.
...
A főoldal tartalmi részén a menü alatt egy üdvözlőszöveg fogadja a látogatót. Alatta az akciós ajánlatok tekinthetők meg, amely aktuális, heti és szezonális bontásban látható. Alatta a közelmúltban érkezett új termékek tekinthetők meg. Ez alatt a népszerű, gyakran vásárolt termékek sora jelenik meg.
