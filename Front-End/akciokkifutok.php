    ...
    <div class="topnav" id="myTopnav">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a class="active" href="akciokkifutok.php"><i class="fa fa-fw fa-hand-o-right"></i> Akciós / kifutó
                    termékek</a>
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div class="flex-item">
                <a href="index.php" target="_blank" rel="noopener">
                    <i class="fa fa-globe" style="font-size:60px;color:white;text-shadow:2px 2px 4px #000000;"></i></a>
                <h3>Web</h3>
